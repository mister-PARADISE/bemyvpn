...
///
/// Три другие оболочки обводят подключённую карточку мятой в полную силу и
/// вдвое толще обычной кромки; у строки терминала контура нет, и роль обводки
/// играет залитый полублок в тот же цвет. Смысл тот же и язык тот же: в этой
/// палитре «работает» — это ЗАЛИТАЯ ПЛОЩАДЬ, а не оттенок текста.
///
