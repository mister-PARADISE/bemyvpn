...
struct PinnedPanel<Content: View>: View {
    ...
    var body: some View {
        VStack(spacing: 8) { content }
            ...
            // Подложка РОВНО цвета страницы и БЕЗ тени.
            //
            // Тень рисовала под панелью тёмную прямоугольную полосу во всю
            // ширину; рядом со скруглённой карточкой она читалась как второй,
            // лишний «блок» позади шапки — на него и жаловались. Убрать саму
            // подложку нельзя: это она не даёт содержимому просвечивать в
            // зазорах по бокам карточки и над ней. Совпадая с фоном страницы,
            // подложка невидима, а панель остаётся отдельным компонентом за
