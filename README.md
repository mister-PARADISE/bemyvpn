...
> 🇬🇧 **English — [README.en.md](README.en.md).** Хостом можно стать и без русского
> интерфейса: команды и флаги английские, а раздача на сервере — это две строки.
...
> 🐳 **Уже есть Docker?** Тогда короче: `packaging/docker` → `docker compose up -d`.
> Права root не нужны, конфиг переживает пересоздание контейнера —
> см. [packaging/docker/README.md](packaging/docker/README.md).
